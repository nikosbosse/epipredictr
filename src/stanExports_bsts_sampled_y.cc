...
#include "stanExports_bsts_sampled_y.h"

RCPP_MODULE(stan_fit4bsts_sampled_y_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("model_bsts_sampled_y")

...
#include "stanExports_bsts_local_trend.h"

RCPP_MODULE(stan_fit4bsts_local_trend_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("model_bsts_local_trend")

...
#include "stanExports_lin_reg_sampled_y.h"

RCPP_MODULE(stan_fit4lin_reg_sampled_y_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("model_lin_reg_sampled_y")

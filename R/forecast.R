...
full_analysis <- function(data) {
	...
	for (country in countries) {
		...
		predictive_samples <- analysis$country_results[[country]]$forecast_res[[best]]$predictive_samples
		y <- analysis$country_results[[country]]$forecast_res[[best]]$y
		
		forecast_run <- analysis$country_results[[country]]$forecast_res[[best]]$forecast_run
